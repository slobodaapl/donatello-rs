    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 52420,
                processed_nodes: 3802,
            },
...
fn pactmaker_3240_3130() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 73195,
                processed_nodes: 5265,
            },
            finish_solver_stats: FinishSolverStats {
                states: 5308,
                values: 81558,
...
fn pactmaker_3240_3130_heart_and_soul() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 2476528,
                states_on_shards: 94756,
                values: 54303744,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 0,
...
fn diadochos_4021_3660() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 43812,
                processed_nodes: 6083,
            },
            finish_solver_stats: FinishSolverStats {
                states: 5308,
                values: 125704,
...
fn rarefied_tacos_de_carne_asada_4785_4758() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 13440579,
                processed_nodes: 1601986,
            },
            finish_solver_stats: FinishSolverStats {
                states: 15891,
                values: 308710,
            ...
            quality_ub_stats: QualityUbSolverStats {
                ...
                states_on_shards: 6291,
                values: 22061897,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 878246,
                states_on_shards: 362448,
                values: 26206137,
            },
        }
    "#]];
...
fn stuffed_peppers_2_heart_and_soul() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 2220575,
                states_on_shards: 1,
                values: 37320256,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 369915,
                states_on_shards: 162964,
                values: 10197928,
            },
        }
    "#]];
...
fn hardened_survey_plank_5558_5216() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 18518318,
                processed_nodes: 2046836,
            },
            finish_solver_stats: FinishSolverStats {
                states: 3619,
                values: 37677,
            ...
            quality_ub_stats: QualityUbSolverStats {
                ...
                states_on_shards: 4189,
                values: 16039913,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 196205,
                states_on_shards: 67220,
                values: 4081536,
            },
        }
    "#]];
...
fn hardened_survey_plank_5558_5216_heart_and_soul_quick_innovation() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 4101743,
                states_on_shards: 133287,
                values: 64746997,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 0,
...
fn ce_stellar_steady_hand() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 1609074,
                processed_nodes: 371960,
            },
            finish_solver_stats: FinishSolverStats {
                states: 10207,
                values: 107674,
            ...
            quality_ub_stats: QualityUbSolverStats {
                ...
                states_on_shards: 84374,
                values: 49937172,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 673566,
                states_on_shards: 203066,
                values: 17231137,
            },
        }
    "#]];
...
fn ce_stellar_steady_hand_2() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 1458043,
                processed_nodes: 151458,
            },
            finish_solver_stats: FinishSolverStats {
                states: 16581,
                values: 113302,
            ...
            quality_ub_stats: QualityUbSolverStats {
                ...
                states_on_shards: 39852,
                values: 74698395,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 1079473,
                states_on_shards: 451379,
                values: 29105973,
            },
        }
    "#]];
