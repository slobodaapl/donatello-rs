...
fn pactmaker_3240_3130() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 44346,
                processed_nodes: 4969,
            },
            finish_solver_stats: FinishSolverStats {
                states: 5308,
                values: 81558,
...
fn pactmaker_3240_3130_heart_and_soul() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 20819,
                processed_nodes: 1488,
            },
            finish_solver_stats: FinishSolverStats {
                states: 15924,
                values: 227871,
...
fn indagator_3858_4057() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 24514,
                processed_nodes: 3689,
            },
            finish_solver_stats: FinishSolverStats {
                states: 5308,
                values: 102529,
...
fn rarefied_tacos_de_carne_asada_4785_4758() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 438024,
                processed_nodes: 71900,
            },
            finish_solver_stats: FinishSolverStats {
                states: 15891,
                values: 308710,
            ...
            quality_ub_stats: QualityUbSolverStats {
                ...
                states_on_shards: 12540,
                values: 16494667,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 943777,
                states_on_shards: 274585,
                values: 14295436,
            },
        }
    "#]];
...
fn stuffed_peppers_2_heart_and_soul() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 2345374,
                states_on_shards: 1,
                values: 30890269,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 429593,
                states_on_shards: 164264,
                values: 6891294,
            },
        }
    "#]];
...
fn black_star_4048_3997() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 146314,
                processed_nodes: 10254,
            },
            finish_solver_stats: FinishSolverStats {
                states: 3248,
                values: 18046,
...
fn claro_walnut_lumber_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 507275,
                processed_nodes: 28825,
            },
            finish_solver_stats: FinishSolverStats {
                states: 8079,
                values: 25429,
...
fn archeo_kingdom_broadsword_4966_4914() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 266780,
                processed_nodes: 15572,
            },
            finish_solver_stats: FinishSolverStats {
                states: 13977,
                values: 379883,
...
fn hardened_survey_plank_5558_5216() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 1272852,
                processed_nodes: 180332,
            },
            finish_solver_stats: FinishSolverStats {
                states: 3619,
                values: 37677,
            ...
            quality_ub_stats: QualityUbSolverStats {
                ...
                states_on_shards: 9656,
                values: 11580483,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 169611,
                states_on_shards: 64696,
                values: 2038223,
            },
        }
    "#]];
